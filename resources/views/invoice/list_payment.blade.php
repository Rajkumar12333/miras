...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
                        <div class="widgetbar">
                            <a href="{{ route('credit_payment.add_page') }}" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add Payment</a>
                        </div>                        
                    </div>
    </div>
</div>
            ...
            <div class="card m-b-30">
                ...
                <h5 class="card-title">Payment Table</h5>
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 {{$start}}
                                    ...
                                    <td>{{$views->payment_from}} </td>
                                    <td>{{$views->agent_name}}</td>
                                    <td>{{$views->card_name}}</td>
                                    <td>{{$views->payment_method}}</td>
                                    <td>{{$views->amount}}</td>
                                    <!-- <td>
                        ...
                        @else
                        <div class="alert alert-secondary" role="alert">No Payment found</div>
                                @endif

                ...
                @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="appointmentDate" name="appoint_date">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="recDate" name="rcddate">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="collDate" name="collectdate">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="sentDate">SentDate</label>
                                <input type="date" class="form-control" id="sentDate" name="sentdate">
                            </div>
                            <div class="form-group col-md-4">

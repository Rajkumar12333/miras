    ...
    <div id="containerbar">
        ...
        <div class="leftbar">
            ...
            <div class="sidebar">
                <!-- Start Logobar -->
                <div class="logobar">
                    <a href="index-2.html" class="logo logo-large"><img src="assets/images/logo.svg" class="img-fluid" alt="logo"></a>
                    <a href="index-2.html" class="logo logo-small"><img src="assets/images/small_logo.svg" class="img-fluid" alt="logo"></a>
                </div>
                <!-- End Logobar -->
                <!-- Start Navigationbar -->

                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-validate" action="{{ route('crud.add') }}" method="post">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label" for="val-username">User ID <span class="text-danger">*</span></label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="title" id="title"  placeholder="Enter User ID">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control" id="content" name="content" rows="5" placeholder="Enter Your Details."></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">

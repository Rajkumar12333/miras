                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="taVaNumber">Catagory:</label>
                                <select id="cat" class="form-control" name="cat" class="mail-inp">
                            ...
                            <div class="form-group col-md-6">
                                <label for="employeeNumber">Fees Amount:</label>
                                <input type="text" class="form-control" id="Fees Amount" name="Fees Amount"

...
<!-- Mirrored from themesbox.in/admin-templates/orbiter/html/light-vertical/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 11:14:51 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div id="containerbar">
        ...
        <div class="leftbar">
            ...
            <div class="sidebar">
                <!-- Start Logobar -->
                <div class="logobar">
                    <a href="index-2.html" class="logo logo-large"><img src="{{ asset('assets/images/logo.svg') }}" class="img-fluid" alt="logo"></a>
                    <a href="index-2.html" class="logo logo-small"><img src="{{ asset('assets/images/small_logo.svg') }}" class="img-fluid" alt="logo"></a>
                </div>
                <!-- End Logobar -->
                <!-- Start Navigationbar -->
...
<!-- Mirrored from themesbox.in/admin-templates/orbiter/html/light-vertical/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 11:15:29 GMT -->
</html>
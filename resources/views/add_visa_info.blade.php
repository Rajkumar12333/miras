...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Add visa Info</h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Add Visa Info</a></li>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{ route('visa_info') }}" class="btn btn-primary-rgba"><i
                        class="feather icon-plus mr-2"></i>Visa info</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="branchid" class="form-control" id="sel" class="box3 branchid"
                                    onchange="vf1(this)">
                            ...
                            <div class="form-group col-md-12">
                                <label for="employeeNumber">Branch: </label>
                                <select name="categoryID" class="form-control" id="sel" class="box3 categoryID"
                                    onchange="vic(this)" style="">
                            ...
                            <div class="form-group col-md-12">
                                <label for="internal-remarks">Visa Info</label>

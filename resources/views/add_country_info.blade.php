...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{ route('country_info') }}" class="btn btn-primary-rgba"><i
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="summernote1" name="editordata1" col="5" rows="5"
                                    placeholder="Description"></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="internal-remarks">Understand</label>
                                <textarea class="form-control" id="Understand" name="Understand"  rows="5"

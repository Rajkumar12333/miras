...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Add Courier</h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Add Courier</a></li>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{ route('courier') }}" class="btn btn-primary-rgba"><i
                        class="feather icon-plus mr-2"></i>Courier list</a>
            </div>
        </div>
    </div>
</div>
...
<div class="contentbar">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="internal-remarks">Select List:</label>
                                <select name="list" class="form-control" id="sel" class="abc" onchange="t(this)" >
    ...
    <option value="Consulate">Consulate</option>
                            ...
                            <div class="form-group col-md-12">
                                <label for="internal-remarks">Country Name:</label>
                            ...
                            <div class="form-group col-md-12">
                                <label for="internal-remarks">No.Of.Documents:</label>
                                <input type="text" class="form-control" id="Recevied document" name="Recevied document"
                                    placeholder="Recevied document">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="internal-remarks">Send Date:</label>
                                <input type="date" class="form-control" id="Recevied document" name="Recevied document"
                                    placeholder="Recevied document">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="internal-remarks">Remarks:</label>
                                <textarea class="form-control" id="remarks" name="editordata" col="5" rows="5"
